...
const displayLectures = (data) => {
  ...
  data.forEach((element, index) => {
    ...
    b_p1.innerHTML = `<strong>Aditya</strong> Created <strong>${element.topic}</strong> Problem's at
    &nbsp;`;

    let b_p2 = document.createElement("p");
    b_p2.innerText = "9 Jul, 22 - 5:30 pm";
